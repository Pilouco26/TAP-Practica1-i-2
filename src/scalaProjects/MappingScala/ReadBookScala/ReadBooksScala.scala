package scalaProjects.MappingScala.ReadBookScala

import javaProject.MapABook.MapAndWord
import javaProject.Mapping.ListAndWord
import scalaProjects.MappingScala.ListAndWordS.ListAndWordS
import scalaProjects.MappingScala.MapABook.MapAndWordS
